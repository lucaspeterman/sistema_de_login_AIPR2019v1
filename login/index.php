...
<html lang="pt-br">
    <head>
        ...
        <title>Sistema de Login LPM Systems</title>
    </head>
<body class="bg-dark">
       ...
       <!-- formulário de cadastro-->
        <section class="row mb-5">
            <div class="col-lg-4 offset-lg-4 bg-light rounded" id="caixaCadastro">
                <h2 class="text-center">Catastro de usuário</h2>
                <form action="#" class="p-2" id="frmCadastro">
                    ...
                    <div class="form-group">
                        <input type="text" name="nomeUsuario" id="nomeUsuario" class="form-control" placeholder="Nome de Usuário" required>
                    </div>

                    <div class="form-group">
                        <input type="email" name="emailUsuario" id="emailUsuario" class="form-control" placeholder="E-mail de Usuário" required>
                    </div>

                    <div class="form-group">
                        <input type="password" name="senhaUsuario" id="senhaUsuario" class="form-control" placeholder="Digite sua senha" required>
                    </div>

                    <div class="form-group">
                    <input type="password" name="senhaComfirma" id="senhaComfirma" class="form-control" placeholder="Comfirme a sua Senha" required>
                    </div>
